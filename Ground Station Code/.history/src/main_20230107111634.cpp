...
void msc_start_cb(uint32_t xferred, uint32_t total)
{
    // this callback function is called when the MSC device is started:
    // do something here...
}

void msc_stop_cb()
{
    // this callback function is called when the MSC device is stopped:
    // do something here...
}
void start_usb_mass_storage()
{
    ...
    usb_msc.setStartStopCallback(msc_start_cb, msc_stop_cb);
...
void loop()
{
    ...
    else
    {
        ...
        Serial.println("unmounted - main loop");
    }
    delay(1000);
