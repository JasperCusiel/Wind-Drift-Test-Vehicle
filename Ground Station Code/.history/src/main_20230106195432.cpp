...
Button upButton(upButtonPin);       // create an up button object
Button downButton(downButtonPin);   // create a down button object
Button leftButton(leftButtonPin);   // create an up button object
Button rightButton(rightButtonPin); // create a down button object
...
void loop()
{
    ...
    // use a switch statement to check the button states:
    switch (mode)
    {
    // if the up button is pressed, change the mode to 2:
    case 1:
    ...
    // if the down button is pressed, change the mode to 1:
    case 2:
    ...
    // wait for a second before checking the button states again:
    delay(1000);
