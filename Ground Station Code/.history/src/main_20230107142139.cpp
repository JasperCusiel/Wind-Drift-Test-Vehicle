...
void start_usb_mass_storage()
{
    ...
    SPI1.setSCK(10);
    SPI1.begin();
    // Set the SS pin for the SD card as pin 10 and use a speed of 8 MHz
    // Use the third argument to specify that we want to use SPI1
    SdSpiConfig spiConfig(10, SD_SCK_MHZ(8), 1);

    // Set the SD card's MOSI, MISO, and SCK pins as pins 11, 12, and 13, respectively
    spiConfig.mosiPin(11);
    spiConfig.misoPin(12);
    spiConfig.sckPin(13);
    ...
    if (!sd.begin(SdSpiConfig(chipSelect, SD_SCK_MHZ(27), 1)))
    {
