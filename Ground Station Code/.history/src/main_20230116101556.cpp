...
//====================================================================================
/**
 * @brief Create sprite the size of a page where either the altimeter of GPS coordinate UI can be pushed
 */
...
void createNeedleHundredth() // Create a Needle Hundredth sprite and push the hundredths needle bitmap image into the needleHundredths sprite
{
