...
// Buttons
Button upButton(upButtonPin, BUTTON_PULLUP_INTERNAL);     // create an up button object
Button downButton(downButtonPin, BUTTON_PULLUP_INTERNAL); // create a down button object
// Variables
