...
void logGPSData()
{
  ...
  if (logCount == 10)
  {
    ...
    sprintf(loraBuffer, "%d:%d:%d.%d,%d,%.6f,%.6f,%.0f,%.1f,%.1f,%.1f,%.1f,%.1f", hour, min, sec, millisecs, fixType, gpsLatitude, gpsLongitude, altimeterAltitude, gpsGroundSpeed, gpsHeading, externalTemp, externalHumidity, lipoStateOfCharge);
