...
/**
 * This function turns off all of the other led indicator led's and only illuminates the red led.
...
/**
 * This function starts the vehicle as a USB thumb drive so that the connected computer can access the contents on the SD card.
