...
bool logGPSData()
{
  ...
  if (logFile)
  {
    ...
    dataString += ',';
    dataString += String(GNSS.getLongitude());
    dataString += ',';
    dataString += String(GNSS.getLatitude());
    dataString += ',';
    dataString += String(GNSS.getAltitude());
    dataString += ',';
    dataString += String(GNSS.getGroundSpeed());
    dataString += ',';
    dataString += String(GNSS.getHeading());
    dataString += ',';
