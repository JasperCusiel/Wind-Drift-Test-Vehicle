...
void logGPSData()
{
  ...
  logFile.print(GNSS.getHour());
  logFile.print(":");
  logFile.print(GNSS.getMinute());
  logFile.print(":");
  logFile.print(GNSS.getSecond());
  logFile.print(',');
  ...
  logFile.print(',');
  logFile.print((GNSS.getAltitude() * 1E-3), 1);
  logFile.print(',');
  logFile.print((GNSS.getGroundSpeed() * 1E-3), 1);
  logFile.print(',');
  logFile.print((GNSS.getHeading() * 1E-5), 1);
  logFile.print(',');
  logFile.print(GNSS.getSIV());
  logFile.print(',');
  logFile.print(GNSS.getFixType());
  logFile.print(',');
  logFile.print(SHT30.getTemperature(), 2);
  logFile.print(',');
  logFile.print(SHT30.getHumidity(), 2);
  logFile.print(',');
  logFile.print(altimeter.getTemperature(), 2);
  logFile.print(',');
  logFile.print(altimeter.altitudeChange(altimeter.getPressure(), startingPressure), 1);
  logFile.print(',');
  logFile.print(lipo.getSOC(), 1);
  logFile.print(',');
  logFile.print(lipo.getChangeRate(), 1);
  logFile.println();
  logFile.close();
}
