...
bool logGPSData()
{
  if (logFile)
  {
    ...
    if ((now - lastMillis) >= 100)
    {
      ...
      dataBuffer += ",";
      dataBuffer += GNSS.getLongitude();
      dataBuffer += ",";
      dataBuffer += GNSS.getLatitude();
      dataBuffer += ",";
      dataBuffer += GNSS.getAltitude();
      dataBuffer += ",";
      dataBuffer += GNSS.getGroundSpeed();
      dataBuffer += ",";
      dataBuffer += GNSS.getHeading();
      dataBuffer += ",";
    ...
    if (chunkSize && dataBuffer.length() >= chunkSize)
    {
      ...
      logFile.write(dataBuffer.c_str(), chunkSize);
