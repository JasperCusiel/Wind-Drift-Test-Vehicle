...
void loop()
{
  ...
  case 1:
    ...
    if (currentLogMillis - previousLogMillis > DELAY_TIME)
    {
      // Run the function
      logGPSData();
      // Update the previous time to be the current time
